...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_alert_rules"></a> [alert\_rules](#module\_alert\_rules) | ./modules/rules | n/a |
...
| Name | Type |
|------|------|
| [grafana_folder.rules_folders](https://registry.terraform.io/providers/grafana/grafana/latest/docs/resources/folder) | resource |
...
| <a name="input_folder_name"></a> [folder\_name](#input\_folder\_name) | The alerts general group folder name to attach all alerts to if no specific folder name set for alert rule item | `string` | `"alerts"` | no |
| <a name="input_folder_name_uids"></a> [folder\_name\_uids](#input\_folder\_name\_uids) | Map of folder names to folder UIDs. If provided, will be used instead of creating folders | `map(string)` | `{}` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_contact_points"></a> [contact\_points](#output\_contact\_points) | The grafana contact points |
| <a name="output_notification_policies"></a> [notification\_policies](#output\_notification\_policies) | The grafana notification policies |
| <a name="output_rule_groups"></a> [rule\_groups](#output\_rule\_groups) | The grafana alert rule groups |
