...
| <a name="input_create_folder"></a> [create\_folder](#input\_create\_folder) | If true, folders are created in this submodule. If false, folders are created centrally. | `bool` | `false` | no |
