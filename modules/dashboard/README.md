...
| <a name="module_elasticache_redis_capacity_widget"></a> [elasticache\_redis\_capacity\_widget](#module\_elasticache\_redis\_capacity\_widget) | ./modules/widgets/elasticache_redis/capacity | n/a |
| <a name="module_elasticache_redis_connections_widget"></a> [elasticache\_redis\_connections\_widget](#module\_elasticache\_redis\_connections\_widget) | ./modules/widgets/elasticache_redis/connections | n/a |
| <a name="module_elasticache_redis_cpu_widget"></a> [elasticache\_redis\_cpu\_widget](#module\_elasticache\_redis\_cpu\_widget) | ./modules/widgets/elasticache_redis/cpu | n/a |
| <a name="module_elasticache_redis_hit_rate_widget"></a> [elasticache\_redis\_hit\_rate\_widget](#module\_elasticache\_redis\_hit\_rate\_widget) | ./modules/widgets/elasticache_redis/hit_rate | n/a |
| <a name="module_elasticache_redis_latency_widget"></a> [elasticache\_redis\_latency\_widget](#module\_elasticache\_redis\_latency\_widget) | ./modules/widgets/elasticache_redis/latency | n/a |
| <a name="module_elasticache_redis_memory_widget"></a> [elasticache\_redis\_memory\_widget](#module\_elasticache\_redis\_memory\_widget) | ./modules/widgets/elasticache_redis/memory | n/a |
| <a name="module_elasticache_redis_new_connections_widget"></a> [elasticache\_redis\_new\_connections\_widget](#module\_elasticache\_redis\_new\_connections\_widget) | ./modules/widgets/elasticache_redis/new_connections | n/a |
| <a name="module_elasticache_redis_reads_widget"></a> [elasticache\_redis\_reads\_widget](#module\_elasticache\_redis\_reads\_widget) | ./modules/widgets/elasticache_redis/reads | n/a |
| <a name="module_elasticache_redis_writes_widget"></a> [elasticache\_redis\_writes\_widget](#module\_elasticache\_redis\_writes\_widget) | ./modules/widgets/elasticache_redis/writes | n/a |
...
| <a name="module_rds_connections_widget"></a> [rds\_connections\_widget](#module\_rds\_connections\_widget) | ./modules/widgets/rds/connections | n/a |
| <a name="module_rds_cpu_widget"></a> [rds\_cpu\_widget](#module\_rds\_cpu\_widget) | ./modules/widgets/rds/cpu | n/a |
| <a name="module_rds_memory_widget"></a> [rds\_memory\_widget](#module\_rds\_memory\_widget) | ./modules/widgets/rds/memory | n/a |
| <a name="module_rds_network_widget"></a> [rds\_network\_widget](#module\_rds\_network\_widget) | ./modules/widgets/rds/network | n/a |
| <a name="module_rds_read_iops_widget"></a> [rds\_read\_iops\_widget](#module\_rds\_read\_iops\_widget) | ./modules/widgets/rds/read_iops | n/a |
| <a name="module_rds_read_latency_widget"></a> [rds\_read\_latency\_widget](#module\_rds\_read\_latency\_widget) | ./modules/widgets/rds/read_latency | n/a |
| <a name="module_rds_write_latency_widget"></a> [rds\_write\_latency\_widget](#module\_rds\_write\_latency\_widget) | ./modules/widgets/rds/write_latency | n/a |
