...
| <a name="input_data_source"></a> [data\_source](#input\_data\_source) | The custom datasource for widget item | <pre>object({<br/>    uid  = optional(string, "cloudwatch")<br/>    type = optional(string, "Cloudwatch")<br/>  })</pre> | n/a | yes |
