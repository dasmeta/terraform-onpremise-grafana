...
| <a name="input_standard_options"></a> [standard\_options](#input\_standard\_options) | Standard options: min/max for the gauge (sending quota scale) | <pre>object({<br/>    min = optional(number)<br/>    max = optional(number)<br/>  })</pre> | <pre>{<br/>  "max": 100000<br/>}</pre> | no |
