...
| <a name="input_standard_options"></a> [standard\_options](#input\_standard\_options) | Standard options: min/max values for the field | <pre>object({<br/>    min = optional(number)<br/>    max = optional(number)<br/>  })</pre> | `null` | no |
