...
| <a name="input_consumer_groups"></a> [consumer\_groups](#input\_consumer\_groups) | Optional consumer groups for DEFAULT MaxOffsetLag and SumOffsetLag panels | `list(string)` | `[]` | no |
...
| <a name="input_topics"></a> [topics](#input\_topics) | Optional topics for DEFAULT consumer-lag dimensions | `list(string)` | `[]` | no |
