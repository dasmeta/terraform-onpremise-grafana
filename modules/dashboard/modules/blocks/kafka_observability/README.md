...
Reusable Grafana dashboard block for Kafka consumer-group and Kafka Connect Prometheus exporters.
...
- `critical_consumer_groups`, `idle_consumer_groups`, `stopped_connectors` for alerts
